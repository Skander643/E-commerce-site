     ...
     $select_products->execute([$name]);
      ...
      if($select_products->rowCount() > 0){
        $message[] = 'product name already exist!';
            ...
            if($image_01_size > 2000000 OR $image_02_size > 2000000 OR
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="flex">
            ...
            <div class="inputBox">
                ...
                <input type="number" min="0" max="9999999999" required placeholder="enter product price (DT)" name="price" onkeypress="if(this.value.length == 10) return false;" class="box">
            </div>
            <div class="inputBox">
